...
public class LmConfig {
    ...
    public static boolean loadConfig() {
        ...
        Yaw=config.getDouble("JoinAngle.Yaw");
        Pitch=config.getDouble("JoinAngle.Pitch");
        HeadYaw=config.getDouble("JoinAngle.HeadYaw");
    ...
    public static boolean saveConfig() {
        ...
        config.set("JoinAngle.HeadYaw", HeadYaw);
        config.set("JoinAngle.Yaw", Yaw);
